...
This is a Selenium Modern Hybrid Framework For Angular And Non Angular Web Applications.
...
> Clone Project
```sh
$ git clone https://github.com/chidvilash302/AngualrTestFramework.git
```
